...
## Local addendum — Wgpu-weld

This policy was founded 2026-08-24, when the canonical core was distributed
across the workspace. Wgpu-weld had 2 documents in `design_docs/` and no policy.
...
- Core §6 requires `design_docs/DOC_README.md` as the canonical index. It does
  not exist here yet; the 2 existing docs are unindexed.
